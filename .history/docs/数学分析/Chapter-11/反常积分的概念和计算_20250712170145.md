...
$$\int_{0}^{1}\frac{1}{x^{p}}\mathrm{d}x=\lim_{\eta\to0+}\frac{x^{-p+1}}{1-p}|_{\eta}^{1}=\lim_{\eta\to0+}\frac{1-\eta^{1-p}}{1-p}=\begin{cases}+\infty&,\quad p>1,\\\frac{1}{1-p},\quad p<1.&\end{cases}$$