...
请看图2.2所示的三种策略。可以看出，三种策略在$s_1$时是不同的。哪种策略最好，哪种策略最差？直观地说，最左边的策略是最好的，因为从$s_1$开始,智能体可以避开禁区。中间的策略直观上较差，因为从$s_1$开始的智能体移动到了禁区。最右边的策略介于其他策略之间，因为智能体进入禁区的概率为$0.5$。
