...
value iteration $\leftarrow$ $v_{1}$ $\leftarrow$ $\begin{aligned}v_{\pi_{1}}^{(0)} &= v_{0} \\v_{\pi_{1}}^{(1)} &= r_{\pi_{1}} + \gamma P_{\pi_{1}} v_{\pi_{1}}^{(0)} \\v_{\pi_{1}}^{(2)} &= r_{\pi_{1}} + \gamma P_{\pi_{1}} v_{\pi_{1}}^{(1)} \\\vdots\end{aligned}$

truncated policy iteration $\leftarrow$ $\bar{v}_{1}$ $\leftarrow$ $begin{aligned}v_{\pi_{1}}^{(j)} = r_{\pi_{1}} + \gamma P_{\pi_{1}} v_{\pi_{1}}^{(j-1)}\\\vdots\end{aligned}$

policy iteration $\leftarrow$ $v_{\pi_{1}}$ $\leftarrow$ $begin{aligned}v_{\pi_{1}}^{(\infty)} = r_{\pi_{1}} + \gamma P_{\pi_{1}} v_{\pi_{1}}^{(\infty)}\\\vdots\end{aligned}$